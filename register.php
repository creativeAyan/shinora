    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM register WHERE email='{$email}'")) > 0) {
            ...
            if ($password === $confirm_password) {
                $sql = "INSERT INTO register (name, email, password, code) VALUES ('{$name}', '{$email}', '{$password}', '{$code}')";
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'ayaangholap32@gmail.com';                     //SMTP username
                        $mail->Password   = 'pizkfodqqnrjtaem';                               //SMTP password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                        //Recipients
                        $mail->setFrom('ayaangholap32@gmail.com','Mailer');
...
<head>
    <title>Login Form - Shinora</title>
    <!-- Meta tag Keywords -->
                ...
                <div class="main-mockup">
                    ...
                    <div class="w3l_form align-self">
                        <div class="left_grid_info">
                            <img src="images/shinora.png" alt="">
                        </div>
                    </div>
